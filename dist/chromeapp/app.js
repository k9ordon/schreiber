(function() {
  ...
  ChromeWindow = (function() {
    function ChromeWindow(app) {
      this.app = app;
      this.dom();
      this.events();
    }

    ChromeWindow.prototype.dom = function() {
      this.$windowClose = document.querySelector('#windowClose');
      this.$windowMinimize = document.querySelector('#windowMinimize');
      return this.$windowMaximize = document.querySelector('#windowMaximize');
    };

    ChromeWindow.prototype.events = function() {
      ...
      return this.$windowMaximize.addEventListener('click', this.windowMaximize);
    };

    ChromeWindow.prototype.closeWindow = function() {
      return chrome.app.window.current().close();
    };

    ChromeWindow.prototype.minimizeWindow = function() {
      return chrome.app.window.current().minimize();
    };

    ChromeWindow.prototype.maximizeWindow = function() {
      var cw;
    ...
    ChromeWindow.prototype.fullscreenWindow = function() {
      var cw;
      cw = chrome.app.window.current();
      if (cw.isFullscreen()) {
        cw.restore();
